...
\begin{center}
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[red,mark=*,only marks] table[x=N,y=steps] {code-fredrik/b_steps.dat};
    \end{axis}
  \end{tikzpicture}
\end{center}
...
\begin{center}
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[red,mark=*,only marks] table[x=N,y expr={1e6*\thisrow{step_time}}] {code-fredrik/b_steps.dat};
    \end{axis}
  \end{tikzpicture}
\end{center}
