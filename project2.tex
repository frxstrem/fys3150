...
\begin{center}
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[blue,dashed,domain=0:100,samples=100] {1.4036*x^2};
      \addplot[red,mark=*,only marks] table[x=N,y=steps] {code-fredrik/b.dat};
    \end{axis}
  \end{tikzpicture}
...
\begin{center}
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[blue,dashed,domain=0:100,samples=100] {2.5743e-3*x^3};
      \addplot[red,mark=*,only marks] table[x=N,y expr={1e6*\thisrow{step_time}}] {code-fredrik/b.dat};
    \end{axis}
  \end{tikzpicture}
...
\begin{center}
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[red,mark=*] table[x=r,y=u] {code-fredrik/d-0.01.dat};
      \addplot[blue,mark=*] table[x=r,y=u] {code-fredrik/d-0.50.dat};
      \addplot[purple,mark=*] table[x=r,y=u] {code-fredrik/d-1.00.dat};
      \addplot[green!50!black,mark=*] table[x=r,y=u] {code-fredrik/d-5.00.dat};
...
\begin{center}
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[blue,dashed,domain=0:100,samples=100] {1.4036*x^2};
      \addplot[red,mark=*,only marks] table[x=N,y=steps] {code-joseph/steps.dat};
    \end{axis}
  \end{tikzpicture}
...
\begin{center}
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[blue,dashed,domain=0:100,samples=100] {8.41835*(x/100)^1.5};
      \addplot[red,mark=*,only marks] table[x=N,y expr={1e6*\thisrow{step_time}}] {code-joseph/steps.dat};
    \end{axis}
  \end{tikzpicture}
