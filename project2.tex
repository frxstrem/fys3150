...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \legend{$\omega_r = 0.01$, $\omega_r = 0.5$, $\omega_r = 1$, $\omega_r = 5$};
    \end{axis}
  \end{tikzpicture}

  \caption{Numerical solutions of \eqref{eq:diff-interact} for different values of $\omega_r$, with $N = 800$ and $\rho_{\rm max} = 60$.} \label{fig:d}
\end{figure}
